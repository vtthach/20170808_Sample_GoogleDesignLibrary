...
public class TabLayoutActivityJava extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tab_layout_java);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_tab_layout_activity_java, menu);
        return true;
    }
    ...
    public static void showMe(@NotNull MainActivity mainActivity) {
        mainActivity.startActivity(new Intent(mainActivity, TabLayoutActivityJava.class));
    }
